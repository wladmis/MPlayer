...
" -vo <drv> выбор  драйвера и устройства видеовывода (список см. с '-vo help')\n"
" -ao <drv> выбор  драйвера и устройства аудиовывода (список см. с '-ao help')\n"
#ifdef CONFIG_VCD
" vcd://<номер трека>  воспоизвести дорожку (S)VCD (Super Video CD)\n"
"                      (непосредственно устройство, а не точка монтирования)\n"
#endif
...
" -nosound         без звука\n"
" -fs              полноэкранное воспроизведение\n"
"                  (или -vm, -zoom, подробности на man-странице)\n"
...
" -vid x -aid y   опции для выбора видео (x) и аудио (y) потока для\n"
"                 воспроизведения\n"
...
" вверх или вниз  перемещение вперёд/назад на  1 минуту\n"
...
"\n"
" * * * ПОДРОБНЕЕ СМОТРИТЕ ДОКУМЕНТАЦИЮ, О ДОПОЛНИТЕЛЬНЫХ ОПЦИЯХ И КЛЮЧАХ! * * *\n"
"\n";
...
#define MSGTR_Filter_UTF8Subtitles "Субтитры в кодировке UTF-8 (*.utf, *.utf-8, *.utf8)"
#define MSGTR_Filter_AllSubtitles "Все субтитры"
#define MSGTR_Filter_AllFiles "Все файлы"
#define MSGTR_Filter_TTF "True Type шрифты (*.ttf)"
#define MSGTR_Filter_Type1 "Type1 шрифты (*.pfb)"
#define MSGTR_Filter_AllFonts "Все шрифты"
#define MSGTR_Filter_FontFiles "Файлы шрифтов (*.desc)"
#define MSGTR_Filter_DDRawAudio "Dolby Digital / PCM (*.ac3, *.pcm)"
#define MSGTR_Filter_MPEGAudio "MPEG-аудио (*.mp2, *.mp3, *.mpga, *.m4a, *.aac, *.f4a)"
#define MSGTR_Filter_MatroskaAudio "Matroska-аудио (*.mka)"
#define MSGTR_Filter_OGGAudio "Ogg-аудио (*.oga, *.ogg, *.spx)"
#define MSGTR_Filter_WAVAudio "WAV-аудио (*.wav)"
#define MSGTR_Filter_WMAAudio "Windows Media аудио (*.wma)"
#define MSGTR_Filter_AllAudioFiles "Все аудио-файлы"
#define MSGTR_Filter_AllVideoFiles "Все видео-файлы"
#define MSGTR_Filter_AVIFiles "AVI-файлы"
#define MSGTR_Filter_DivXFiles "DivX-файлы"
#define MSGTR_Filter_FlashVideo "Flash-видео"
#define MSGTR_Filter_MP3Files "MP3-файлы"
#define MSGTR_Filter_MP4Files "MP4-файлы"
#define MSGTR_Filter_MPEGFiles "MPEG-файлы"
#define MSGTR_Filter_MP2TS "MPEG-2-потоки"
#define MSGTR_Filter_MatroskaMedia "Matroska-медиа"
#define MSGTR_Filter_OGGMedia "Ogg-медиа"
#define MSGTR_Filter_QTMedia "QuickTime-медиа"
#define MSGTR_Filter_RNMedia "RealNetworks-медиа"
#define MSGTR_Filter_VideoCDImages "VCD/SVCD-изображения"
#define MSGTR_Filter_WAVFiles "WAV-файлы"
#define MSGTR_Filter_WindowsMedia "Windows-медиа"
#define MSGTR_Filter_Playlists "Списки воспроизведения"
...
#define MSGTR_ICONERROR "Иконка '%s' (размер %d) не найдена или в неподдерживаемом формате.\n"

// --- skin loader error messages
#define MSGTR_SKIN_ERRORMESSAGE "[скин] ошибка в файле конфигурации скина на строке %d: %s"
#define MSGTR_SKIN_ERROR_SECTION "Не указана секция для '%s'.\n"
#define MSGTR_SKIN_ERROR_WINDOW "Не указано окно для '%s'.\n"
#define MSGTR_SKIN_ERROR_ITEM "Этот элемент не поддерживается '%s'.\n"
#define MSGTR_SKIN_UNKNOWN_ITEM "Неизвестный элемент '%s'\n"
#define MSGTR_SKIN_UNKNOWN_NAME "Неизвестное название '%s'\n"
...
#define MSGTR_SKIN_TooManyItemsDeclared "Объявлено слишком много элементов.\n"
...
#define MSGTR_SKIN_SKINCFG_SkinCfgError "Ошибка обработки файла конфигурации со скином '%s'\n"
#define MSGTR_SKIN_LABEL "Скины:"

// --- GTK menus
#define MSGTR_MENU_AboutMPlayer "О MPlayer"
#define MSGTR_MENU_Open "Открыть..."
#define MSGTR_MENU_PlayFile "Воспроизвести файл..."
#define MSGTR_MENU_PlayCD "Воспроизвести CD..."
#define MSGTR_MENU_PlayVCD "Воспроизвести VCD..."
#define MSGTR_MENU_PlayDVD "Воспроизвести DVD..."
#define MSGTR_MENU_PlayURL "Воспроизвести URL..."
...
#define MSGTR_MENU_SkinBrowser "Просмотр скинов"
...
#define MSGTR_PREFERENCES_OSD_LEVEL0 "Только субтитры"
#define MSGTR_PREFERENCES_OSD_LEVEL1 "Громкость и перемещение"
#define MSGTR_PREFERENCES_OSD_LEVEL2 "Громкост, перемещение, таймер и проценты"
#define MSGTR_PREFERENCES_OSD_LEVEL3 "Громкост, перемещение, таймер, проценты и общее время"
...
#define MSGTR_PREFERENCES_VideoHardwareAcceleration "Аппаратное ускорение видео:"
...
#define MSGTR_PREFERENCES_NoIdle "Выйти после воспроизведения"
...
#define MSGTR_PREFERENCES_ArtsBroken "Новые версии aRts несовместимы "\
           "с GTK 1.x и приведут к крушению GMPlayer!"
...
#define MSGTR_AO_SUN_CantOpenAudioDev "[AO SUN] Не могу открыть аудио-устройство %s, %s -> nosound.\n"
#define MSGTR_AO_SUN_UnsupSampleRate "[AO SUN] audio_setup: ваша карта не поддерживает канал %d, %s, частоту дискретизации %d Гц.\n"
...
#define MSGTR_AF_LADSPA_WarnNoInputs "ПРЕДУПРЕЖДЕНИЕ! У этого LADSPA-плагина нет аудио-входов.\n  Входящий аудио-сигнал будет потерян."
...
#define MSGTR_AF_LADSPA_ErrNoOutputs "У этого LADSPA плагина отсутствуют аудио-выходы."
...
#define MSGTR_INPUT_INPUT_ErrCantInitJoystick "Невозможно инициализировать джойстик ввода\n"
#define MSGTR_INPUT_INPUT_ErrCantOpenFile "Невозможно открыть %s: %s\n"
#define MSGTR_INPUT_INPUT_ErrCantInitAppleRemote "Невозможно инициализировать Apple Remote.\n"
...
#define MSGTR_FormatNotRecognized "======= Извините, формат этого файла не распознан/поддерживается ==========\n"\
                                  "===== Если этот файл в AVI, ASF или MPEG потоке, пожалуйста свяжитесь с автором! ======\n"
#define MSGTR_SettingProcessPriority "Устанавливается приоритет процесса: %s\n"
...
#define MSGTR_CantSeekRawAVI "Невозможно перемещаться в сыром AVI-потоке! (Требуется индекс, попробуйте с ключом -idx!)\n"
#define MSGTR_CantSeekFile "Невозможно перемещаться в этом файле!\n"

#define MSGTR_MOVcomprhdr "MOV: Поддержка сжатых заголовков требует ZLIB!\n"
...
#define MSGTR_CannotOpenAudioStream "Невозможно открыть аудиопоток: %s\n"
#define MSGTR_CannotOpenSubtitlesStream "Невозможно открыть поток субтитров: %s\n"
#define MSGTR_OpeningAudioDemuxerFailed "Сбой открытия демультиплексора аудио: %s\n"
#define MSGTR_OpeningSubtitlesDemuxerFailed "Сбой открытия демультиплексора субтитров: %s\n"
#define MSGTR_TVInputNotSeekable "По ТВ-входу невозможно перемещаться! (Возможно, перемещение будет для смены каналов ;)\n"
...
#define MSGTR_MPDEMUX_MKV_ZlibDecompressionFailed "[mkv] сбой zlib-распаковки.\n"
#define MSGTR_MPDEMUX_MKV_LzoInitializationFailed "[mkv] сбой инициализации lzo.\n"
#define MSGTR_MPDEMUX_MKV_LzoDecompressionFailed "[mkv] сбой lzo распаковки.\n"
#define MSGTR_MPDEMUX_MKV_TrackEncrypted "[mkv] Дорожка номер %u зашифрована, а расшифровка еще не реализована.\n[mkv] Пропуск дорожки.\n"
...
#define MSGTR_MPDEMUX_MKV_NoVideoTrackFound "[mkv] Не найдена/требуется видео-дорожка.\n"
#define MSGTR_MPDEMUX_MKV_NoAudioTrackFound "[mkv] Не найдена/требуется аудио-дорожка.\n"
#define MSGTR_MPDEMUX_MKV_WillDisplaySubtitleTrack "[mkv] Будет отображаться дорожка субтитров %u.\n"
#define MSGTR_MPDEMUX_MKV_NoBlockDurationForSubtitleTrackFound "[mkv] Предупреждение: Не найдена BlockDuration для дорожки субтитров.\n"
