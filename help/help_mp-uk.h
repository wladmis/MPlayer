...
#define MSGTR_InvalidIP "Опция -udp-ip: непридатній IP-адрес\n"
...
// format.c
#define MSGTR_AF_FORMAT_UnknownFormat "невідомий формат "


// ========================== LIBMPDEMUX ===================================

// muxer.c, muxer_*.c
#define MSGTR_TooManyStreams "Надто багато потоків!"
#define MSGTR_RawMuxerOnlyOneStream "Мультиплексор rawaudio підтримує лише один потік!\n"
#define MSGTR_IgnoringVideoStream "Игнорую відеопотік!\n"
#define MSGTR_UnknownStreamType "Попередження, невідомий тип потоку: %d\n"
#define MSGTR_WarningLenIsntDivisible "Попередження, довжина не кратна разміру фрагмента!\n"
#define MSGTR_MuxbufMallocErr "Мультиплексор фреймбуфера не може виділити пам'ять!\n"
#define MSGTR_MuxbufReallocErr "Мультиплексор фреймбуфера не може перевиділити пам'ять!\n"
#define MSGTR_WritingHeader "Запис заголовка...\n"
#define MSGTR_WritingTrailer "Запис індекса...\n"

// demuxer.c, demux_*.c
#define MSGTR_AudioStreamRedefined "ПОПЕРЕДЖЕННЯ: Заголовок аудіопотоку %d переозначено!\n"
#define MSGTR_VideoStreamRedefined "ПОПЕРЕДЖЕННЯ: Заголовок відеопотокуа %d переозначено!\n"
#define MSGTR_TooManyAudioInBuffer "\nНадто багато аудіопакетів в буфері: (%d в %d байтах).\n"
#define MSGTR_TooManyVideoInBuffer "\nНадто багато відеопакетів в буфері: (%d в %d байтах).\n"
#define MSGTR_MaybeNI "Можливо ви відтворюєте неперемежований потік/файл або невдалий кодек?\n" \
                      "Для AVI-файлів спробуйте форсувати неперемежований режим опцією -ni.\n"
#define MSGTR_WorkAroundBlockAlignHeaderBug "AVI: Обхід помилки CBR-MP3 nBlockAlign заголовка!\n"
#define MSGTR_SwitchToNi "\nВиявлено погано перемежований AVI-файл - переключаюсь у -ni режим...\n"
#define MSGTR_InvalidAudioStreamNosound "AVI: непридатний ID аудіопотоку: %d - игнорування (nosound)\n"
#define MSGTR_InvalidAudioStreamUsingDefault "AVI: непридатний ID відеопотоку: %d - игнорування (використовується типове значення)\n"
#define MSGTR_ON2AviFormat "ON2 AVI формат"
#define MSGTR_Detected_XXX_FileFormat "Виявлено %s формат файла!\n"
#define MSGTR_DetectedAudiofile "Виявлено аудіофайл.\n"
#define MSGTR_InvalidMPEGES "Непридатний потік MPEG-ES??? зв'яжіться з автором, можливо це дефект :(\n"
#define MSGTR_FormatNotRecognized "======= Нажаль, формат цього файла не впізнано/підтримується ==========\n"\
                                  "===== Якщо цей файл в AVI, ASF чи MPEG потоці, будь-ласка зв'яжіться з автором! ======\n"
#define MSGTR_SettingProcessPriority "Встановлюється приоритет процеса: %s\n"
#define MSGTR_FilefmtFourccSizeFpsFtime "[V] filefmt:%d  fourcc:0x%X  size:%dx%d  fps:%5.3f  ftime:=%6.4f\n"
#define MSGTR_CannotInitializeMuxer "Неможливо иныцыювати мультиплексор."
#define MSGTR_MissingVideoStream "Відеопоток не знайдено!\n"
#define MSGTR_MissingAudioStream "Аудіопоток не знайдено -> без звуку\n"
#define MSGTR_MissingVideoStreamBug "Відеопоток втрачено!? зв'яжіться з автором, моливо це дефект :(\n"

#define MSGTR_DoesntContainSelectedStream "demux: у файлі нема вибраного аудіо- або відеопотоку\n"

#define MSGTR_NI_Forced "Форсований"
#define MSGTR_NI_Detected "Виявлений"
#define MSGTR_NI_Message "%s НЕПЕРЕМЕЖОВАНИЙ формат AVI-файла!\n"

#define MSGTR_UsingNINI "Використання НЕПЕРЕМЕЖОВАНОГО зламаного формату AVI-файла!\n"
#define MSGTR_CouldntDetFNo "Не зміг визначити кількість кадрів (для абсолютного переміщення).\n"
#define MSGTR_CantSeekRawAVI "Неможливо переміщуватися в сирому AVI-потоці! (Требуется индекс, попробуйте с ключом -idx!)\n"
#define MSGTR_CantSeekFile "Неможливо переміщуватися в цьому файлі!\n"

#define MSGTR_MOVcomprhdr "MOV: Підтримка стиснених заголовків потребує ZLIB!\n"
#define MSGTR_MOVvariableFourCC "MOV: ПОПЕРЕДЖЕННЯ! Виявлено змінну FOURCC!?\n"
#define MSGTR_MOVtooManyTrk "MOV: ПОПЕРЕДЖЕННЯ! надто багато доріжок!"
#define MSGTR_DetectedTV "Виявлено ТВ! ;-)\n"
#define MSGTR_ErrorOpeningOGGDemuxer "Не в змозі відкрити демультиплексор Ogg.\n"
#define MSGTR_CannotOpenAudioStream "Неможливо відкрити аудіопотік: %s\n"
